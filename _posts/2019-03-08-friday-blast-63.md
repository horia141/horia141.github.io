...
[Pixie - a system for recommending 3+ billion items to 200+ million users in real-time (2018)](https://blog.acolyer.org/2018/05/23/pixie-a-system-for-recommending-3-billion-items-to-200-million-users-in-real-time/) - an overview of a Pinterest paper about their recommendation engine. These sorts of things are the backbones of many companies - Netflix, Pinterest, Facebook etc. But they're eusually glossed over in ML courses. But they're interesting in their own right and very tricky to get right. So this is an interesting discussion of how the Pinterest teams does it.
